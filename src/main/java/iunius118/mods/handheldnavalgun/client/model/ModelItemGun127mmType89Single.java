...
public class ModelItemGun127mmType89Single
{
     ...
     * Reload Animation
     *
     * 80-75 recoil and draw rammer 75-60 counter-recoil (75-70 release breech) 60-45 eject cartridge (60-50) and set round (59-50) on tray (50-) 45-35 push tray 35-15 load round and
     * push rammer 15-05 draw tray 05-02 close breech
     */
    ...
    public void registerRendererCrewA()
    {
        ...
        this.crew1.renderPart = context -> {
            // render crew only first person view
            if (context.getValue().isFirstPersonView)
            {
                this.crew1.children = ImmutableList.of(this.legL1, this.legR1, this.body1, this.skirt1);
            }
            else
